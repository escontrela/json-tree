...
class SettingsScreenLayoutContractTest {
  ...
  void settingsFxmlUsesConditionalVerticalScrollingAndExposesNightModeToggle()
    ...
    assertTrue(fxml.contains("fx:id=\"applyButton\""));
    assertTrue(!fxml.contains("fx:id=\"settingsToolbarBackButton\""));
    assertTrue(fxml.contains("/com/davidpe/jsontree/images/close_35dp_000000.png"));
    assertTrue(fxml.contains("/com/davidpe/jsontree/images/close_35dp_FFFFFF.png"));
